Public Class FrmInsertOrder
    ...
    Private Sub FrmInsertOrder_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub InsertOrder_Click(sender As Object, e As EventArgs) Handles InsertOrder.Click
        ...
        Try
            ...
            '登録
            If Not Order.InsertOrder(title,
                                        detail,
                                        contractStartDate,
                                        contractEndDate,
                                        contractMoney,
